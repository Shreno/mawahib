...
Route::prefix('admin')->middleware(['auth','ActiveAccount','IsAdmin'])->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('join-requests/resolve',[BackendJoinRequestController::class,'resolve'])->name('join-requests.resolve');

        Route::resource('join-requests',BackendJoinRequestController::class);
