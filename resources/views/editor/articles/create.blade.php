...
<div class="col-12 p-3">
    <div class="col-12 col-lg-12 p-0 ">
        <form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('editor.articles.store')}}">
            @csrf
                ...
                <div class="col-12 p-3 row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="version" class="form-control" value="{{ old('last_version') }}">
                        </div>
