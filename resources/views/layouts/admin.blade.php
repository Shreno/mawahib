        ...
        <div class="col-12 px-0 pb-4 text-center justify-content-center align-items-center ">
            ...
            <div class="col-12 px-0">
                ...
                <div class="col-12 px-3 aside-menu" style="height: calc(100vh - 260px);overflow: auto;">
                    ...
                    @can('users-read')
                    <a href="{{route('admin.creators.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                    ...
                    @can('join-requests-read')
                    <a href="{{route('admin.join-requests.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                            ...
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                 طلبات الإنضمام 
                            @php
                            $JoinRequest = \App\Models\JoinRequest::where('status','pending')->count();
                            @endphp
                            @if($JoinRequest)
                            <span style="background: #d34339;border-radius: 2px;color:var(--background-1);display: inline-block;font-size: 11px;text-align: center;padding: 1px 5px;margin: 0px 8px">{{$JoinRequest}}</span>
