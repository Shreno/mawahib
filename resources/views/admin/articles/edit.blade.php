                ...
                <div class="col-12 p-3 row">
                    ...
                    <div class="col-12 p-2">
                        ...
                        <div class="card-header text-center">
                            ...
                            <input type="text" name="app_link" class="form-control" placeholder="أدخل رابط التحميل من Google Play" value="{{ $article->app_link }}" >
                        </div>
                    
                        <div class="card-body">
                            <div class="form-group">
                                <label>اسم التطبيق</label>
                                <input type="text" name="app_name" class="form-control" value="{{ $article->app_name }}" >
                            </div>
